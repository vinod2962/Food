...
import { SafeAreaView, ScrollView, Text, View, FlatList, toUpperCase, Image, TouchableOpacity } from "react-native"
        ...
        <SafeAreaView
            ...
            >
                <View
                    ...
                    <TouchableOpacity onPress={() => props.navigation.navigate('MenuData')}>
                        <Image
                            style={{
                                height:27,
                                width: 27,
